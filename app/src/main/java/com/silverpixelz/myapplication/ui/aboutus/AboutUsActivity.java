package com.silverpixelz.myapplication.ui.aboutus;
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            Transition enter_transition =
                    TransitionInflater.from(this).
                            inflateTransition(R.transition.trns_about_us);
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (id) {
                    case R.id.menu_home:
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                            startActivity(ih,
                                    ActivityOptions.makeSceneTransitionAnimation((Activity) AboutUsActivity.this).toBundle());
                        } else {
                            startActivity(ih);
                        }
                        break;
